...
import com.congcong.shopping.home.adapter.HomeFragmentAdapter;
...
public class GoodsInfoActivity extends Activity implements View.OnClickListener {
     ...
     * <br />
     * Auto-created on 2020-03-04 11:26:50 by Android Layout Finder
...
//设置数据
    ...
    private void setWebViewData(String product_id) {
        if (product_id !=null){
            wbGoodInfoMore.loadUrl("http://wwwatguigu.com");
            //设置支持javascrite
            WebSettings webSettings = wbGoodInfoMore.getSettings();
            webSettings.setUseWideViewPort(true);//支持双击也页面变大变小
            ...
            wbGoodInfoMore.setWebViewClient(new WebViewClient() {
                ...
                public boolean shouldOverrideUrlLoading(WebView view, String url) {
                    //返回值是true的时候去控制WebView打开，为false调用系统浏览器或第三方浏览器
                    view.loadUrl(url);
                    return true;
                }
